        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-600 mb-3 italic">
              "TypeScript is required in 67% of React job postings on ArcLancer. Adding TypeScript could increase your invite rate by ~35%."
            </p>
    ...
    <div className="space-y-5">
      ...
      <div className="border border-gray-200 rounded-2xl p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <button className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border border-gray-200 rounded-2xl p-6">
        ...
        <button
          ...
          className={`flex items-center gap-2 text-sm font-bold px-6 py-3 rounded-xl transition mb-5
            ${tracking ? "bg-red-500 hover:bg-red-600 text-white" : "bg-blue-500 hover:bg-blue-600 text-white"}`}>
          {tracking ? (
            <>
          ...
          {["10min", "30min", "Off"].map(opt => (
            <button key={opt} onClick={() => setScreenshotFreq(opt)}
              className={`text-xs font-semibold px-3 py-1 rounded-lg border transition
                ${screenshotFreq === opt ? "bg-blue-50 border-blue-300 text-blue-700" : "bg-white border-gray-200 text-gray-500 hover:border-gray-300"}`}>
              Every {opt === "Off" ? "" : ""}{opt}
            </button>
          ))}
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-1.5 text-sm text-gray-700 border border-gray-300 rounded-lg px-3 py-2 hover:bg-gray-50 transition">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between bg-white border border-gray-200 rounded-xl px-4 py-3">
                  ...
                  <div className="flex gap-1.5 flex-shrink-0">
                    {[1,2,3].map(i => (
                      <div key={i} className={`h-2 w-8 rounded-full ${i <= 1 ? "bg-blue-500" : "bg-gray-200"}`}/>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["All Skills", "Budget", "Best Match", "Most Recent"].map(f => (
                      <button key={f} className={`flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold transition
                        ${f === "Best Match" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>
                        {f === "All Skills" && (
                        ...
                        <div className="flex flex-wrap gap-1.5 mb-3">
                          {job.skills.map(s => (
                            <span key={s} className={`text-xs px-2.5 py-0.5 rounded-full font-medium border
                              ${s.includes("✓") ? "bg-blue-50 text-blue-700 border-blue-200" : "bg-gray-100 text-gray-600 border-gray-200"}`}>
                              {s}
                            </span>
                          ))}
                        </div>
