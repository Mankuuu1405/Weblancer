...
//                         value={phone}
//                         onChange={e => { setPhone(e.target.value); setCodeSent(false); setCode(""); }}
//                         className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-green-400 focus:ring-2 focus:ring-green-100 transition mb-3"
//                       />
...
//                           onClick={handleSendCode}
//                           disabled={phone.length < 6}
//                           className="w-full py-2.5 rounded-xl text-sm font-semibold transition wbl-btn-inline disabled:opacity-40 disabled:cursor-not-allowed text-white"
//                         >
//                           Send Verification Code
//                         </button>
//                       )}
...
//                             value={code}
//                             onChange={e => { setCode(e.target.value.replace(/\D/g, "")); setCodeError(""); }}
//                             className="w-full border-2 border-blue-400 rounded-xl px-3 py-2.5 text-sm text-center tracking-[0.5em] font-bold outline-none focus:border-green-400 focus:ring-2 focus:ring-green-100 transition mb-3"
//                           />
//                           {codeError && (
//                             <p className="text-red-500 text-xs mb-2">{codeError}</p>
//                           )}
...
//                             <button
//                               onClick={handleVerifyCode}
//                               className="flex-1 py-2.5 rounded-xl text-sm font-semibold wbl-btn-inline text-white transition"
//                             >
//                               Verify
//                             </button>
//                             <button
...
//                   {["Prevent fake accounts", "Enable important notifications", "Required for secure payments"].map((item, i) => (
//                     <li key={i} className="text-sm text-gray-600 flex items-center gap-2">
//                       <span className="wbl-text-blue font-bold">✓</span> {item}
//                     </li>
//                   ))}
//                 </ul>
//               </div>
...
//                   <div className="flex justify-between text-xs text-gray-500 mb-1.5">
//                     <span>Verification progress</span>
//                     <span className="font-semibold wbl-text-blue">
//                       {emailVerified && phoneVerified ? 100 : emailVerified || phoneVerified ? 50 : 0}%
//                     </span>
//                   </div>
//                   <div className="w-full bg-gray-100 rounded-full h-1.5">
//                     <div
//                       className="wbl-bg h-1.5 rounded-full transition-all duration-500"
//                       style={{ width: `${emailVerified && phoneVerified ? 100 : emailVerified || phoneVerified ? 50 : 0}%` }}
//                     />
//                   </div>
//                 </div>
