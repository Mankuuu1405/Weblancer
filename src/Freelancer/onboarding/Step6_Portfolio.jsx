...
//               <div className="mb-7">
//                 <span className="text-xs font-bold border border-blue-400 wbl-text-blue px-3 py-1 rounded-full uppercase tracking-wide">
//                   Portfolio Validation
//                 </span>
//               </div>
...
//                       onChange={e => { setGithubUrl(e.target.value); setGithubAnalyzed(false); setGithubResult(null); }}
//                       placeholder="github.com/username"
//                       className="flex-1 border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-green-400 focus:ring-2 focus:ring-green-100 transition bg-gray-50"
//                     />
//                     <button
//                       onClick={handleGithubAnalyze}
//                       disabled={!githubUrl.trim() || githubAnalyzing}
//                       className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-white transition disabled:opacity-40 disabled:cursor-not-allowed
//                         wbl-btn-inline whitespace-nowrap"
//                     >
//                       {githubAnalyzing ? (
//                         <>
//                           <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
...
//                       <div className="mt-2 flex flex-wrap gap-1.5">
//                         {githubResult.languages.map(lang => (
//                           <span key={lang} className="text-xs bg-blue-50 text-blue-700 font-medium px-2 py-0.5 rounded-full">{lang}</span>
//                         ))}
//                       </div>
//                     </div>
//                   )}
...
//                 <div className="border border-gray-200 rounded-xl p-5">
//                   <div className="flex items-center gap-2 mb-1">
//                     <svg className="w-5 h-5 wbl-text-blue flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/>
//                     </svg>
//                     <span className="text-sm font-bold text-gray-800">Live Project Links</span>
//                   </div>
...
//                               onClick={() => handleAnalyzeLink(i)}
//                               disabled={analyzingLink === i}
//                               className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl text-xs font-semibold text-white wbl-btn-inline transition disabled:opacity-50 whitespace-nowrap"
//                             >
//                               {analyzingLink === i ? (
//                                 <svg className="w-3.5 h-3.5 animate-spin" fill="none" viewBox="0 0 24 24">
//                                   <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/>
...
//                           {i === projectLinks.length - 1 && !link.trim() && (
//                             <button onClick={handleAddLink}
//                               className="w-9 h-9 rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center text-gray-400 hover:border-blue-400 hover:wbl-text-blue transition flex-shrink-0">
//                               <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4"/>
//                               </svg>
//                             </button>
...
//                     {projectLinks[projectLinks.length - 1].trim() && (
//                       <button onClick={handleAddLink}
//                         className="flex items-center gap-2 text-sm wbl-text-blue hover:text-blue-700 font-medium transition mt-1">
//                         <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4"/>
//                         </svg>
//                         Add another link
...
//                     {Object.keys(analyzedLinks).map(i => (
//                       <div key={i} className="flex items-center gap-2">
//                         <div className="w-1.5 h-1.5 rounded-full wbl-bg flex-shrink-0"></div>
//                         <span className="text-xs text-gray-600 truncate">Live project #{parseInt(i) + 1}</span>
//                       </div>
//                     ))}
//                     {uploadedDocs.map((doc, i) => (
