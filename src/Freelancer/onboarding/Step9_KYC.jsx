...
// `}</style>
//     <div className={`border-2 border-dashed rounded-xl p-5 flex flex-col items-center justify-center gap-3 transition min-h-[160px]
//       ${uploaded ? "border-green-300 bg-green-50" : "border-gray-200 bg-white hover:border-blue-300 hover:bg-green-50"}`}>
//       {uploaded ? (
//         <>
//           <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center">
//             <svg className="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//           <p className="text-sm font-semibold text-green-700">{label} — Uploaded</p>
//           <button onClick={() => ref.current.click()}
//             className="text-xs wbl-text-blue hover:underline">Change file</button>
//         </>
//       ) : (
//         <>
//           <DocIcon/>
...
//                             setUploads({ front: false, back: false });
//                           }}
//                           className={`w-full text-left px-5 py-3 text-sm flex items-center gap-2 hover:bg-green-50 transition
//                             ${opt === idType ? "wbl-text-blue font-semibold bg-blue-50" : "text-gray-700"}`}
//                         >
//                           {opt === idType && (
