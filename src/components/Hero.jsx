    ...
    <section className="bg-[rgb(249,250,252)] px-5 pt-16 pb-20 text-center">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="flex justify-center items-center gap-4 flex-wrap mb-10">
          <button className="flex items-center gap-2.5 px-6 py-4 rounded-[14px] bg-gradient-to-r from-[#4f7cff] to-[#5a67ff] text-white text-lg font-semibold shadow-[0_10px_25px_rgba(79,124,255,0.25)] hover:-translate-y-0.5 transition-all cursor-pointer border-none">
        ...
        <div className="mt-16 px-8 py-12 bg-[#e8edf7] rounded-2xl border border-[#d1d9f0] text-center">
          ...
          <button className="flex items-center gap-2 mx-auto px-6 py-4 rounded-[14px] bg-gradient-to-r from-[#4f7cff] to-[#5a67ff] text-white text-lg font-semibold shadow-[0_10px_25px_rgba(79,124,255,0.25)] hover:-translate-y-0.5 transition-all cursor-pointer border-none">
