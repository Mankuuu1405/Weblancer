...
//   active:              { bg: G.greenBg,   text: G.greenDark,dot: G.green,   border: G.greenBorder },
//   on_hold:             { bg: "#fff7ed",   text: "#c2410c",  dot: "#f97316", border: "#fed7aa"     },
//   completed:           { bg: "#eff6ff",   text: "#1d4ed8",  dot: "#3b82f6", border: "#bfdbfe"     },
...
//   delivered:   { bg: G.greenBg, text: G.greenDark,dot: G.green    },
...
//   paid:     { bg: G.greenBg, text: G.greenDark },
// };
...
//           background: G.green, color: G.white, border: "none", borderRadius: 8, padding: "7px 14px",
...
//             <h1 style={{ fontSize: 22, fontWeight: 800, color: G.text, margin: 0, letterSpacing: "-0.4px" }}>Contracts</h1>
...
//               { label: "Completed",     val: stats.done,                                 accent: "#2563eb"     },
//               { label: "Total Value",   val: `₹${(stats.totalVal  / 100000).toFixed(1)}L`, accent: G.greenDark },
//               { label: "Collected",     val: `₹${(stats.totalPaid / 100000).toFixed(1)}L`, accent: G.green    },
//             ].map((s, i, arr) => (
...
//       style={{ background: G.white, border: `1.5px solid ${hov ? G.greenBorder : G.border}`,
//         borderRadius: 14, padding: "18px 22px", cursor: "pointer",
//         transition: "all 0.15s", boxShadow: hov ? "0 4px 20px rgba(34,197,94,0.1)" : "none",
...
//         <p style={{ fontSize: 13, fontWeight: 700, color: G.text, lineHeight: 1.3 }}>{c.company}</p>
...
//           <p style={{ fontSize: 10, color: G.greenDark, fontWeight: 700 }}>{paid}%</p>
//         </div>
//         <div style={{ background: "#f3f4f6", borderRadius: 99, height: 5, overflow: "hidden" }}>
//           <div style={{ width: `${paid}%`, height: "100%", background: `linear-gradient(90deg,${G.green},#86efac)`, borderRadius: 99, transition: "width 0.3s" }} />
//         </div>
...
//         {c.nextMilestone
//           ? <p style={{ fontSize: 12, color: G.greenDark, fontWeight: 700 }}>{c.nextMilestone}</p>
//           : <p style={{ fontSize: 12, color: G.muted }}>—</p>}
//       </div>

//       <div style={{ width: 90, flexShrink: 0, textAlign: "center" }}>
//         {sigBoth
//           ? <span style={{ fontSize: 11, fontWeight: 700, color: G.greenDark, background: G.greenBg, border: `1px solid ${G.greenBorder}`, borderRadius: 7, padding: "4px 8px" }}>✓ Signed</span>
...
//       <svg width="14" height="14" fill="none" stroke={hov ? G.green : "#d1d5db"} viewBox="0 0 24 24"
...
//         <div style={{ background: "linear-gradient(135deg,#14532d,#166534)", padding: "20px 26px 0" }}>
//           <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
//             <div>
//               <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }}>
//                 <span style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", fontWeight: 600 }}>{c.id}</span>
//                 <span style={{ color: "rgba(255,255,255,0.2)" }}>·</span>
//                 <span style={{ fontSize: 11, color: "#86efac", fontWeight: 600 }}>← {c.proposalId}</span>
...
//               <span style={{ fontSize: 12, color: "#86efac", fontWeight: 700 }}>{paid}% collected · {fmt(c.totalPaid)} / {fmt(c.value)}</span>
//             </div>
//             <div style={{ background: "rgba(255,255,255,0.1)", borderRadius: 99, height: 6, overflow: "hidden" }}>
//               <div style={{ width: `${paid}%`, height: "100%", background: `linear-gradient(90deg,${G.green},#86efac)`, borderRadius: 99, transition: "width 0.4s" }} />
//             </div>
//           </div>
...
//                 background: sig.ok ? "rgba(34,197,94,0.12)" : "rgba(245,158,11,0.12)",
//                 border: `1px solid ${sig.ok ? "rgba(34,197,94,0.25)" : "rgba(245,158,11,0.25)"}`,
...
//                   <p style={{ fontSize: 14, fontWeight: 700, color: G.text }}>{c.client}</p>
//                   <p style={{ fontSize: 13, color: G.sub }}>{c.company}</p>
//                   <p style={{ fontSize: 13, color: G.sub }}>{c.email}</p>
//                 </SBox>
//                 <SBox style={{ background: G.greenBg, border: `1px solid ${G.greenBorder}` }}>
//                   <SLabel>Contract Value</SLabel>
//                   <p style={{ fontSize: 24, fontWeight: 800, color: G.greenDark, letterSpacing: "-0.5px" }}>{fmt(c.value)}</p>
...
//                       <span style={{ fontSize: 12, fontWeight: 700, color: G.greenDark }}>{c.progressPct}%</span>
//                     </div>
//                     <div style={{ background: "#f3f4f6", borderRadius: 99, height: 7, overflow: "hidden" }}>
//                       <div style={{ width: `${c.progressPct}%`, height: "100%", background: `linear-gradient(90deg,${G.green},#86efac)`, borderRadius: 99 }} />
//                     </div>
//                   </div>
...
//                   </div>
//                   <button style={{ fontSize: 12, color: G.green, fontWeight: 700, background: "none", border: "none", cursor: "pointer" }}>Download</button>
//                 </div>
//               )}
//             </div>
//           )}
...
//                 {[
//                   { label: "Total",   val: fmt(c.value),              color: G.text    },
//                   { label: "Paid",    val: fmt(c.totalPaid),          color: G.greenDark },
...
//                     background: m.status === "paid" ? G.greenBg : G.white }}>
...
//                           </span>
//                           {m.invoiced && <span style={{ fontSize: 11, fontWeight: 600, background: G.greenBg, color: G.greenDark, border: `1px solid ${G.greenBorder}`, padding: "2px 8px", borderRadius: 99 }}>📄 Invoiced</span>}
//                         </div>
//                         <p style={{ fontSize: 12, color: G.sub }}>Due: {m.due}</p>
//                       </div>
//                       <div style={{ textAlign: "right", marginLeft: 16 }}>
//                         <p style={{ fontSize: 16, fontWeight: 700, color: m.status === "paid" ? G.greenDark : G.text }}>{fmt(m.amount)}</p>
//                         {m.status !== "paid" && (
//                           <div style={{ display: "flex", gap: 6, marginTop: 6, justifyContent: "flex-end" }}>
//                             {m.status === "pending"  && <Mbtn onClick={() => markMilestone(i, "invoiced")} color={G.sub}>Raise Invoice</Mbtn>}
//                             {m.status === "invoiced" && <Mbtn onClick={() => markMilestone(i, "paid")} color={G.greenDark} border={G.greenBorder} bg={G.greenBg}>Mark Paid ✓</Mbtn>}
//                           </div>
//                         )}
//                         {m.status === "paid" && <p style={{ fontSize: 11, color: G.green, fontWeight: 700, marginTop: 4 }}>✓ Cleared</p>}
//                       </div>
//                     </div>
//                   </div>
//                 );
...
//                 return (
//                   <div key={i} style={{ border: `1px solid ${G.border}`, borderRadius: 12, padding: "14px 16px",
//                     background: d.status === "approved" ? G.greenBg : G.white, borderLeft: `3px solid ${ds.dot}` }}>
...
//                         {d.status === "in_progress" && <Mbtn onClick={() => markDeliverable(i, "delivered")} color={G.greenDark} bg={G.greenBg} border={G.greenBorder}>Mark Delivered</Mbtn>}
//                         {d.status === "delivered"   && <Mbtn onClick={() => markDeliverable(i, "approved")} color={G.greenDark} bg={G.greenBg} border={G.greenBorder}>Client Approved ✓</Mbtn>}
//                         {d.status === "approved"    && <span style={{ fontSize: 12, color: G.green, fontWeight: 700 }}>✓ Approved</span>}
//                       </div>
//                     </div>
//                   </div>
//                 );
...
//                     border: `3px solid ${G.white}`, boxShadow: `0 0 0 2px ${G.green}`,
...
//             {c.stage === "on_hold"            && <FBtn style={{ color: G.greenDark, borderColor: G.greenBorder, background: G.greenBg }}>▶ Resume</FBtn>}
//             {c.stage === "active"             && <FBtn style={{ background: G.green, color: G.white, border: "none" }}>✓ Mark Completed</FBtn>}
//             {c.stage === "awaiting_signature" && <FBtn style={{ background: "#2563eb", color: G.white, border: "none" }}>📤 Resend to Client</FBtn>}
//           </div>
//         </div>
//       </div>
//     </Overlay>
...
//                 <p style={{ fontSize: 15, fontWeight: 800, color: G.text, marginBottom: 14, fontFamily: FONT }}>Review Contract</p>
...
//                   </div>
//                 ))}
//                 <div style={{ borderTop: `1px solid ${G.greenBorder}`, paddingTop: 12, marginTop: 4 }}>
...
//           {step < TOTAL
//             ? <FBtn onClick={() => setStep(step + 1)} style={{ background: G.green, color: G.white, border: "none" }}>Next →</FBtn>
//             : <FBtn style={{ background: G.green, color: G.white, border: "none" }}>Send for Signature 📤</FBtn>}
//         </div>
//       </div>
//     </Overlay>
//   );
...
//       display: "flex", alignItems: "center", justifyContent: "center",
//       background: "rgba(17,24,39,0.45)", backdropFilter: "blur(4px)", padding: 20 }}>
