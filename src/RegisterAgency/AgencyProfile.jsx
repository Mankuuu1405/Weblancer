...
const AgencyProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      {/* Navbar */}
      <div className="bg-white border-b border-gray-200 px-4 sm:px-8 py-3 flex justify-between items-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 flex flex-col gap-5">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-7 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-5 mb-5">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl flex items-center justify-center text-white text-xl sm:text-2xl font-extrabold flex-shrink-0"
