...
export default function AdminLayout({ children }) {
  ...
  const SidebarContent = ({ isMobile = false }) => (
    <>
      ...
      <div style={{
        ...
        padding: collapsed && !isMobile ? "12px 0" : "6px 14px 6px 10px",
        borderBottom: `1px solid rgba(255,255,255,0.07)`,
        minHeight: 60,
      }}>
        {(!collapsed || isMobile) ? (
              ...
              return (
                ...
                >
                  <span style={{
                    ...
                    color: active ? G.green : "rgba(255,255,255,0.35)",
                    flexShrink: 0,
                    width: collapsed && !isMobile ? "auto" : 18,
                    textAlign: "center",
                  }}>
                    {item.icon}
                  </span>
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: G.bg, fontFamily: FONT, overflow: "hidden" }}>
      ...
      <style>{`
        ...
        * { scrollbar-width: none; }
        ...
        .wl-sidebar-desktop {
          ...
          transition: width 0.2s ease;
          overflow: hidden;
          box-shadow: 4px 0 24px rgba(15,26,59,0.18);
          background: linear-gradient(160deg, #1e3a1e 0%, #1A2B5E 35%, #0F1A3B 65%, #0a1628 100%);
        }
        ...
        .wl-mobile-overlay.open {
          display: flex;
        }
        .wl-mobile-backdrop {
          position: absolute;
          inset: 0;
          background: rgba(15,26,59,0.55);
        }
        .wl-mobile-drawer {
          position: relative;
          width: 260px;
          ...
          flex-direction: column;
          background: linear-gradient(160deg, #1e3a1e 0%, #1A2B5E 35%, #0F1A3B 65%, #0a1628 100%);
          box-shadow: 4px 0 32px rgba(15,26,59,0.3);
        }
        ...
        /* Mobile: full responsive adjustments */
        @media (max-width: 640px) {
          .wl-topbar-breadcrumb {
            display: none;
          }
          .wl-topbar-admin-label {
            display: none;
          }
          .wl-page-padding {
          ...
          .wl-responsive-grid-3 {
            grid-template-columns: 1fr !important;
          }
          .wl-responsive-grid-4 {
            grid-template-columns: 1fr 1fr !important;
          }
          .wl-responsive-grid-2 {
            grid-template-columns: 1fr !important;
          }
          .wl-table-scroll {
            overflow-x: auto;
      ...
      <div className={`wl-mobile-overlay ${mobileOpen ? "open" : ""}`}>
        <div className="wl-mobile-backdrop" onClick={() => setMobileOpen(false)} />
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
            ...
            <div className="wl-topbar-breadcrumb" style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
              <span style={{ fontSize: 13, fontWeight: 700, color: G.navy, whiteSpace: "nowrap" }}>Weblance</span>
              <span style={{ color: G.greenBorder, fontSize: 13 }}>/</span>
              <span style={{ fontSize: 12, color: G.muted, fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                {breadcrumb || "Dashboard"}
              </span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
            ...
            <div style={{
              ...
              <div className="wl-topbar-admin-label">
                <p style={{ fontSize: 11, fontWeight: 700, color: G.navy, margin: 0, lineHeight: 1.2 }}>Super Admin</p>
                <p style={{ fontSize: 9, color: G.muted, margin: 0, lineHeight: 1.2 }}>admin@weblance.com</p>
              </div>
            </div>
