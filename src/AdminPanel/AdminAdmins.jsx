...
/* ── Responsive style block shared across all three pages ── */
const RESPONSIVE_CSS = `
  ...
  * { font-family: 'Poppins', sans-serif; }
  ...
  /* ── Admin page layout ── */
  .adm-layout { display: flex; gap: 20px; }
  .adm-main   { flex: 1; min-width: 0; }
  .adm-side   { width: 288px; flex-shrink: 0; }

  /* ── Admin row ── */
  .adm-row-stats { display: flex; align-items: center; gap: 24px; flex-shrink: 0; }
  .adm-row-stat  { text-align: center; }

  /* ── Roles grid ── */
  .roles-grid { display: grid; grid-template-columns: 1fr 3fr; gap: 20px; }

  /* ── Audit log detail grid ── */
  .audit-detail-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px 32px; }

  /* ────────────────────────────────────
     TABLET  ≤1024px
  ──────────────────────────────────── */
  @media (max-width: 1024px) {
    .roles-grid { grid-template-columns: 200px 1fr; gap: 16px; }
    .adm-side   { width: 240px; }
  }
  ...
  @media (max-width: 768px) {
    ...
    /* Hide Today/Total counts in admin row on small screens */
    .adm-row-stats { gap: 12px; }
    .adm-stat-hide { display: none; }

    .roles-grid { grid-template-columns: 1fr; }
    .audit-detail-grid { grid-template-columns: 1fr; gap: 6px; }
  ...
  @media (max-width: 480px) {
    .adm-padding { padding: 16px 14px 48px !important; }
    .adm-row-email { display: none; }
    .adm-row-stats { display: none; }
  }
`;
...
// ─── MOCK DATA ────────────────────────────────────────────────────────────────
const mockAdmins = [
  { id: "ADM-001", name: "Prerna Sharma",  email: "prerna@weblance.com",        role: "Super Admin",    status: "Active",   lastLogin: "Mar 14, 2026 · 10:32 AM", lastLoginIp: "192.168.1.1", joinedDate: "Jan 1, 2025",  twoFA: true,  actionsToday: 12, totalActions: 847, permissions: ["Full Access"],                          avatar: "PS" },
  { id: "ADM-002", name: "Rahul Kapoor",   email: "rahul.admin@weblance.com",   role: "Platform Admin", status: "Active",   lastLogin: "Mar 14, 2026 · 09:15 AM", lastLoginIp: "192.168.1.2", joinedDate: "Mar 15, 2025", twoFA: true,  actionsToday: 8,  totalActions: 412, permissions: ["Users","Projects","Disputes","KYC"],   avatar: "RK" },
  { id: "ADM-003", name: "Sneha Verma",    email: "sneha.finance@weblance.com", role: "Finance Admin",  status: "Active",   lastLogin: "Mar 13, 2026 · 04:45 PM", lastLoginIp: "192.168.1.4", joinedDate: "Jun 1, 2025",  twoFA: true,  actionsToday: 3,  totalActions: 289, permissions: ["Payments","Escrow","Payouts","Commission"], avatar: "SV" },
  { id: "ADM-004", name: "Dev Kumar",      email: "dev.support@weblance.com",   role: "Support Admin",  status: "Active",   lastLogin: "Mar 12, 2026 · 02:10 PM", lastLoginIp: "192.168.1.3", joinedDate: "Sep 10, 2025", twoFA: false, actionsToday: 5,  totalActions: 134, permissions: ["Users (read)","Disputes (read)","KYC (read)"], avatar: "DK" },
  { id: "ADM-005", name: "Ananya Mishra",  email: "ananya.aiops@weblance.com",  role: "AI Ops Admin",   status: "Inactive", lastLogin: "Feb 28, 2026 · 11:00 AM", lastLoginIp: "192.168.1.5", joinedDate: "Nov 5, 2025",  twoFA: true,  actionsToday: 0,  totalActions: 67,  permissions: ["AI Settings","AI Logs","AI Overrides"], avatar: "AM" },
];

const mockRoles = [
  { id: "ROLE-001", name: "Super Admin",    color: "bg-red-500",    desc: "Full platform access — all features, all data, all controls",             admins: 1, permissions: { "User Management": { view: true, edit: true, delete: true }, "KYC Verification": { view: true, edit: true, delete: true }, "Projects": { view: true, edit: true, delete: true }, "Disputes": { view: true, edit: true, delete: true }, "Payments & Escrow": { view: true, edit: true, delete: true }, "AI Settings": { view: true, edit: true, delete: true }, "Audit Logs": { view: true, edit: false, delete: false }, "Admin Management": { view: true, edit: true, delete: true }, "Announcements": { view: true, edit: true, delete: true }, "Platform Settings": { view: true, edit: true, delete: true } } },
  { id: "ROLE-002", name: "Platform Admin", color: "bg-green-500",  desc: "Manages users, projects, disputes & KYC — no financial controls",         admins: 1, permissions: { "User Management": { view: true, edit: true, delete: false }, "KYC Verification": { view: true, edit: true, delete: false }, "Projects": { view: true, edit: true, delete: false }, "Disputes": { view: true, edit: true, delete: false }, "Payments & Escrow": { view: true, edit: false, delete: false }, "AI Settings": { view: false, edit: false, delete: false }, "Audit Logs": { view: true, edit: false, delete: false }, "Admin Management": { view: false, edit: false, delete: false }, "Announcements": { view: true, edit: true, delete: false }, "Platform Settings": { view: true, edit: false, delete: false } } },
  { id: "ROLE-003", name: "Finance Admin",  color: "bg-blue-500",   desc: "Controls all financial operations — escrow, payouts, commission",          admins: 1, permissions: { "User Management": { view: true, edit: false, delete: false }, "KYC Verification": { view: true, edit: true, delete: false }, "Projects": { view: true, edit: false, delete: false }, "Disputes": { view: true, edit: false, delete: false }, "Payments & Escrow": { view: true, edit: true, delete: false }, "AI Settings": { view: false, edit: false, delete: false }, "Audit Logs": { view: true, edit: false, delete: false }, "Admin Management": { view: false, edit: false, delete: false }, "Announcements": { view: false, edit: false, delete: false }, "Platform Settings": { view: false, edit: false, delete: false } } },
  { id: "ROLE-004", name: "Support Admin",  color: "bg-yellow-500", desc: "Read-only access to users, disputes & KYC for support purposes",           admins: 1, permissions: { "User Management": { view: true, edit: false, delete: false }, "KYC Verification": { view: true, edit: false, delete: false }, "Projects": { view: true, edit: false, delete: false }, "Disputes": { view: true, edit: false, delete: false }, "Payments & Escrow": { view: false, edit: false, delete: false }, "AI Settings": { view: false, edit: false, delete: false }, "Audit Logs": { view: true, edit: false, delete: false }, "Admin Management": { view: false, edit: false, delete: false }, "Announcements": { view: false, edit: false, delete: false }, "Platform Settings": { view: false, edit: false, delete: false } } },
  { id: "ROLE-005", name: "AI Ops Admin",   color: "bg-purple-500", desc: "Manages AI thresholds, reviews AI decisions & overrides",                  admins: 1, permissions: { "User Management": { view: true, edit: false, delete: false }, "KYC Verification": { view: false, edit: false, delete: false }, "Projects": { view: true, edit: false, delete: false }, "Disputes": { view: true, edit: false, delete: false }, "Payments & Escrow": { view: false, edit: false, delete: false }, "AI Settings": { view: true, edit: true, delete: false }, "Audit Logs": { view: true, edit: false, delete: false }, "Admin Management": { view: false, edit: false, delete: false }, "Announcements": { view: false, edit: false, delete: false }, "Platform Settings": { view: false, edit: false, delete: false } } },
];
...
const roleColor = {
  "Super Admin": "bg-red-500", "Platform Admin": "bg-green-500",
  "Finance Admin": "bg-blue-500", "Support Admin": "bg-yellow-500", "AI Ops Admin": "bg-purple-500",
};
...
export function AdminAdmins() {
  ...
  const handleInvite = () => {
    ...
    setAdmins(prev => [...prev, {
      ...
      status: "Pending", lastLogin: "Never", lastLoginIp: "—", joinedDate: "Mar 14, 2026",
      twoFA: false, actionsToday: 0, totalActions: 0, permissions: [],
      avatar: inviteForm.name.split(" ").map(n => n[0]).join("").slice(0, 2).toUpperCase(),
    }]);
    setInviteForm({ name: "", email: "", role: "Platform Admin" });
    setShowInvite(false);
              ...
              {filtered.map((admin) => (
                <div key={admin.id}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="adm-row-email text-xs text-gray-400">{admin.email}</p>
                    <p className="text-[10px] text-gray-300 mt-0.5">Last login: {admin.lastLogin}</p>
                  </div>

                  <div className="adm-row-stats">
                    <div className="adm-row-stat">
                      <p className="text-sm font-bold text-gray-700">{admin.actionsToday}</p>
                      <p className="text-[10px] text-gray-400">Today</p>
                    </div>
                    <div className="adm-row-stat adm-stat-hide">
                      <p className="text-sm font-bold text-gray-700">{admin.totalActions}</p>
                      <p className="text-[10px] text-gray-400">Total</p>
                    </div>
                    <span className={`text-[11px] font-semibold px-2 py-0.5 rounded-full ${admin.status === "Active" ? "bg-green-50 text-green-600 border border-green-200" : admin.status === "Pending" ? "bg-yellow-50 text-yellow-600 border border-yellow-200" : "bg-gray-50 text-gray-500 border border-gray-200"}`}>
...
export function AdminRoles() {
  ...
  const selectRole = (role) => { setSelectedRole(role); setPermissions(role.permissions); setEditMode(false); };
  const togglePerm = (resource, type) => {
    setPermissions(prev => ({ ...prev, [resource]: { ...prev[resource], [type]: !prev[resource][type] } }));
  };
  const permResources = Object.keys(mockRoles[0].permissions);
                  ...
                  {permResources.map((resource, i) => (
                    <tr key={resource} className={`border-b border-gray-50 last:border-0 ${i % 2 === 0 ? "bg-white" : "bg-gray-50/30"}`}>
                      ...
                      {["view", "edit", "delete"].map(type => (
                        <td key={type} className="px-4 py-3 text-center">
                          {editMode ? (
                            <button onClick={() => togglePerm(resource, type)}
                              className={`w-6 h-6 rounded-full flex items-center justify-center mx-auto transition-colors ${permissions[resource]?.[type] ? "bg-green-500 text-white" : "bg-gray-100 text-gray-300 hover:bg-gray-200"}`}>
                              {permissions[resource]?.[type] ? "✓" : "✕"}
                            </button>
                          ) : (
            ...
            <div className="px-5 py-4 bg-gray-50 border-t border-gray-100">
              <div className="flex items-center gap-6 flex-wrap">
                ...
                {[
                  ...
                  { label: "Edit — Can make changes",     color: "text-green-500" },
                  { label: "Delete — Can remove data",    color: "text-red-400"   },
                ].map(l => <span key={l.label} className={`text-xs ${l.color}`}>{l.label}</span>)}
                <span className="text-xs text-gray-300 ml-auto">✕ = No access &nbsp; ✓ = Has access</span>
              </div>
            </div>
          </div>
    ...
    <div className="adm-padding p-6">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-gray-50">
          {filtered.map(log => (
            <div key={log.id} className="hover:bg-gray-50/50 transition-colors">
              <div className="flex items-start gap-4 p-4 cursor-pointer" onClick={() => setExpanded(expanded === log.id ? null : log.id)}>
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${categoryIconBg[log.category] || "bg-gray-100 text-gray-500"}`}>
                  <span className="text-sm">{categoryIcon[log.category] || "◈"}</span>
                </div>
