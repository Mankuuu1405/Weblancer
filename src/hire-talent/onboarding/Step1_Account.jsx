...
//     3: { label: "Good",   bars: 3, clr: "#eab308" },
//     4: { label: "Strong", bars: 4, clr: "#22c55e" },
//   };
...
//             <span className="text-sm" style={{ color: "#94a3b8" }}>or sign up with email</span>
//             <div className="flex-1 h-px" style={{ backgroundColor: "#e2e8f0" }} />
//           </div>
...
//                   style={{ ...inputStyle, color: local.country ? "#1e293b" : "#94a3b8" }}
//                   onFocus={e => e.target.style.borderColor = "#3b5bdb"}
//                   onBlur={e  => e.target.style.borderColor = "#e2e8f0"}
//                 >
...
//                   ))}
//                 </select>
//                 <span className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#94a3b8" }}>
//                   <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//                         <path d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
//                       </svg>
//                     ) : (
//                       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//                           style={{
//                             backgroundColor: i <= strength.bars ? strength.clr : "#e2e8f0",
//                           }}
//                         />
//                       ))}
//                     </div>
//                     <span className="text-xs font-semibold" style={{ color: strength.clr }}>
//                       {strength.label}
//                     </span>
//                   </div>
//                 )}
...
//                   style={{
//                     ...inputStyle,
//                     borderColor: pwdMismatch ? "#ef4444" : pwdMatch ? "#22c55e" : "#e2e8f0",
//                   }}
//                   onFocus={e => e.target.style.borderColor = "#3b5bdb"}
...
//                     style={{ color: pwdMatch ? "#22c55e" : "#ef4444" }}
//                   >
...
//               style={{ backgroundColor: "#f0f4ff", border: "1px solid #e0e7ff" }}
//             >
//               <span
//                 className="text-xs font-bold px-2 py-0.5 rounded"
//                 style={{ backgroundColor: "#dde5ff", color: "#3b5bdb" }}
//               >
//                 Client
//               </span>
//               <span style={{ color: "#475569" }}>Role auto-selected: Posting Projects</span>
//             </div>
...
//               <span>
//                 I agree to the{" "}
//                 <a href="#" className="font-semibold underline" style={{ color: "#3b5bdb" }}>Terms of Service</a>
//                 {" "}and{" "}
//                 <a href="#" className="font-semibold underline" style={{ color: "#3b5bdb" }}>Privacy Policy</a>
//               </span>
//             </label>
//           </div>
//         </div>
...
//             style={{
//               backgroundColor: canSubmit ? "#3b5bdb" : "#93c5fd",
...
//               Start filling in the form to see real-time feedback.
//             </p>
//           ) : (
//             <div className="flex flex-col gap-2">
//               {insights.map((item, i) => (
...
export default function AccountStep({ formData, updateData, next }) {
  ...
  const canSubmit = nameValid && emailValid && local.country && local.password.length>=8 && pwdMatch && agreed;
        ...
        <div className="rounded-2xl overflow-hidden" style={{ backgroundColor:"white", border:`1px solid ${G.greenBorder}`, boxShadow:"0 4px 24px rgba(110,192,48,0.08)" }}>
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="flex flex-col gap-5">
              ...
              <Field label="Full Name *">
                <input type="text" placeholder="John Smith" value={local.fullName} onChange={set("fullName")}
                  className="w-full px-4 py-3 rounded-xl text-sm outline-none transition-all"
                  style={inputStyle}
